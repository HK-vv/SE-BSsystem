...
| 查看比赛排名与结果分析功能 | D3         | （超级）管理员可以在比赛结束后查看比赛排行榜和比赛结果分析 |
...
| 8    | 文本   | 显示所有题目     | 字符     | 供（超级）管理员勾选比赛的题目                                  |
...
（超级）管理员可以在比赛管理功能处看到包含所有比赛信息的列表，点击比赛名称后面的“排行榜”按钮可以查看对应比赛的排名情况，点击“结果分析”可以查看用户的答题情况。
...
| 3    | 按钮 | 排行榜   | 按钮     | 点击后弹窗显示比赛排行榜，包含用户的用户名、正确率、用时（） |
| 4    | 按钮 | 结果分析 | 按钮     | 查看比赛结果分析                                             |
