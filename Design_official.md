...
| 子功能名称             | 子功能代号 | 描述                                                                                                     |
| ---------------------- | ---------- | -------------------------------------------------------------------------------------------------------- |
| 创建比赛功能           | D1         | （超级）管理员确定比赛名称，选择比赛开始时间、答题时间、题目、是否为私密比赛、是否 rating 属性以创建比赛 |
| 查看排名与答题情况功能 | D2         | （超级）管理员可以在比赛结束后查看比赛排名和用户答题情况、错误分布                                       |
| 公布赛题功能           | D3         | （超级）管理员可以在比赛结束后选择将赛题设为公开，供用户自主组卷练习                                     |
| 更新 rating 功能       | D4         | （超级）管理员可以在比赛结束后选择手动更新 rating，可以与赛前设置不同（避免因出题事故造成的不公平性）    |
