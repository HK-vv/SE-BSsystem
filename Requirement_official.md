...
| 22.03.21 | v0.5 | 刘昀鑫 | 编写功能性需求-自主组卷练习功能，删除了所有功能性需求中下属的界面条目 |
...
3.当点击题库管理的时候，上栏显示由条件搜索题目的搜索框、添加题目按钮、批量删除按钮和修改公开状态按钮；下栏则显示题库中的题目。在添加题目这个弹窗界面中支持从题库添加、从问卷星平台批量导入和从excel表格导入三个功能，具体界面显示入下图：

![屏幕截图 2022-03-22 170331](https://user-images.githubusercontent.com/40681587/159444823-c5e05550-5888-4769-ad40-7589c1fdc3d5.png)
